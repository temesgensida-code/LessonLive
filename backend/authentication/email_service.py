...
def send_password_reset_email(user, token, frontend_base_url):
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>You requested a password reset for your LessonLive account. Please click the button below to reset your password:</p>
                <div style="text-align: center;">
    ...
    try:
        ...
        params = {
            "from": from_email,
            "to": [user.email],
            "subject": "Reset your password - LessonLive",
            "html": html_content,
        }
